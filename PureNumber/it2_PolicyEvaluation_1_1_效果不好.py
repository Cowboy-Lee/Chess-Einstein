...
# 电脑学习爱恩斯坦棋的规则。
#
#   —— 14层结构输入，4层网络（2Conv+2FC），只学习可走子规则。
#
#
...
def trainNetwork(s, readout, sess):
    ...
    checkpoint = tf.train.get_checkpoint_state("PolicyTrainerCheckpoints/")
    ...
    while "Einstein_Policy" != "Einstein":
        ...
        if t % 100000 == 0:
            saver.save(sess, 'PolicyTrainerCheckpoints/' + GAME , global_step = t)
            print("graph saved.")
