...
# 电脑学习爱恩斯坦棋的规则。
#
#   —— 单层结构输入，5层网络（3Conv+2FC），只学习第一种选择是否可以。
#
#
...
def trainNetwork(s, readout, sess):
    ...
    checkpoint = tf.train.get_checkpoint_state("PolicyTrainercheckpoints_Deeper_Simpler/")
    ...
    while "Einstein_Policy" != "Einstein":
        ...
        if t % 100000 == 0:
            saver.save(sess, 'PolicyTrainercheckpoints_Deeper_Simpler/' + GAME , global_step = t)
            print("graph saved.")
